...
namespace Pds.Contracts.FeedProcessor.Services.Tests.Unit
{
    ...
    public class Deserializer_v1104Tests
    {
        ...
        private readonly ILoggerAdapter<Deserializer_v1104> _loggerAdapter
            = Mock.Of<ILoggerAdapter<Deserializer_v1104>>(MockBehavior.Strict);
        ...
        public void Deserilize_NullUKPRN_RaisesException()
        {
            ...
            ns.AddNamespace("c", Deserializer_v1104._contractEvent_Namespace);
        ...
        private Deserializer_v1104 GetDeserializer()
            => new Deserializer_v1104(_validationService, _auditService, _loggerAdapter);
